...
function App() {
  return (
    <Router basename={"/templatemonster/react/templezen/"}>
      <Suspense fallback={<div></div>}>
        <ScrollToTop>
          <Switch>
            ...
            {/* Sermon */}
            <Route exact path="/sermon/tag/:tagId" component={props => (<Sermon {...props} key={window.location.pathname} />)} />
            <Route exact path="/sermon/author/:authorId" component={props => (<Sermon {...props} key={window.location.pathname} />)} />
